...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="<?= ADMIN; ?>/"><i class="fa fa-home"></i>
                    <span>Home</span></a> </li>
                <li><a href="<?= ADMIN; ?>/order"><i class="fa fa-shopping-cart"></i>
                ...
                <li><a href="<?= ADMIN; ?>/cache"><i class="fa fa-navicon"></i>
                        <span>Кэширование</span></a></li>


                <li class="treeview">
                    <a href="#"><i class="fa fa-cubes"></i><span>Пользователи</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?= ADMIN ?>/user">Список пользователей</a></li>
                        <li><a href="<?= ADMIN ?>/user/add">Редактирование пользователей</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-cubes"></i><span>Фильтры</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left"></i></span>
                    </a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-cubes"></i><span>Валюты</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left"></i></span>
                    </a>
                    <ul class="treeview-menu">
    ...
    <footer class="main-footer">
        ...
        <strong>ColorGold &copy; 2021</strong>
    </footer>
