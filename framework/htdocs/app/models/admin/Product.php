...
class Product extends AppModel
{
    ...
    public function editRelatedProduct($id, $data){
        $related_product = \R::getCol('SELECT related_id FROM related_product WHERE
product_id = ?', [$id]);
        ...
        //если изменились связаные товары - удалим и запишем новые
    ...
    public function editFilter($id, $data)
    {
        ...
        //если изменились фильтры - удалим и запишим новые
